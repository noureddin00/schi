...
return [
   ...
   'summary' => 'Summary',
   'class_notes' => 'Class Notes (Optional)',   'embed_source_hint' => '(Provide the source url only)',
   'video_url_hint' => '(Provide the shareable url only)',
   'type_content_placeholder' => 'Type your content here...',
   'image_caption_placeholder' => 'Type caption for image (optional)',
   'enter_instructions_here' => 'Enter instructions here...',
   'enter_payment_details' => 'Enter payment details here...',
   'enter_image_caption' => 'Enter image caption here...',
   'uploading' => 'Uploading...',
   'lesson_pricing_type' => 'Lesson pricing type',   'enable_drip_content' => 'Enable drip content',
